...
public class Fecha implements Comparable<Fecha> {
	...
	/**
	 * incrementa una fecha la cantidad de dias que se le indica
	 * @param fecha
	 * @param dias
	 * @return Fecha
	 * 
	 */
	public static Fecha avanzarNDias(Fecha fecha,int dias) {
		Fecha fechanueva = new Fecha(fecha.dia(),fecha.mes(),fecha.anio());
		for(int i = 0; i < dias; i++)
			fechanueva.avanzarUnDia();
